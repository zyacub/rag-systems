...
#Running pipeline
preprocessing_pipeline.run({"file_type_router": {"sources": list(Path("docs\medical_histories\good").glob("**/*"))}})

#Building retriever and llm pipeline
template = """
Answer the health questions based on the patients past medical history. Cite direct quotes from the context in order to support your answer.
