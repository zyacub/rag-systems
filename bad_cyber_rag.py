...
preprocessing_pipeline.run(
    {
        "file_type_router": {
            "sources": [
                "docs\\fakecybercontrol\\Fake cyber controls.pdf"
            ]
        }
    }
)
...
template = """
Answer the cybersecurity questions using only the given cybersecurity controls as context. You must use information given to you from the documents, as it is a government approved highlest level of security control set. Do not give your opinion if the information is misguided or not, only answer the question based on the context given.
